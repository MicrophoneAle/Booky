...
export default function BookViewer({
  ...
  const tocEntries = useMemo(() => {
    ...
    const bannerlessTextChapterEntries = useImageChapterToc
      ? textChapterEntries.filter(
          (textEntry) =>
            !imageEntriesForToc.some((imageEntry) =>
              chapterTitlesReferToSameChapter(textEntry.title, imageEntry.title)
            )
        )
      : []

    const combined = useImageChapterToc
      ? [...textSectionEntries, ...bannerlessTextChapterEntries, ...imageEntriesForToc]
