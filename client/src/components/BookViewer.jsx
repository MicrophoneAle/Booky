...
const PAGINATION_MEASUREMENT_VERSION = 7
...
/** Page height so width-first scaling fills the visual viewport. */
...
/** Scale pages to cover the viewport in mobile fullscreen (no letterboxing). */
